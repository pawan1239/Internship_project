...
import verbal_noun
import place_noun
import district_noun
import state_noun
import landmark_noun
import date_month_noun
import uncountable_noun
import person_name
import surname
import person_name_1
import landmark_noun_1
import surname_1
import state_noun_1
import place_noun_1
...
#Function for printing the unknown tagged word at end of each sentence
        ...
        for p in range(0, len(l)):
            if p+6<=len(l):
                if (l[p] == 'Demonstrative_Pro' and l[p + 3] == 'JJ') or (l[p] == 'Quantifier' and l[p + 3] == 'JJ'):
                    if (l[p + 6] == 'UNK'):
                        l[p + 6] = 'N'
    #Applying prepositional rule to tagg noun
        for p in range(0,len(l)):
            if p-6>=0:
                if l[p]=='Preposition' and l[p-3]=='N' and l[p-6]=='UNK' and l[p-3]!='PU':
                    l[p-6]='N'
            if p-9>=0:
                if l[p]=='Preposition' and l[p-3]=='N' and l[p-6]=='N' and l[p-9]=='UNK' and l[p-6]!='PU':
                    l[p-9]='N'
            if p-12>=0:
                if l[p]=='Preposition' and l[p-3]=='N' and l[p-6]=='N' and l[p-9]=='N' and l[p-12]=='UNK' and l[p-9]!='PU':
                    l[p-12]='N'
   ...
   #check_middle(text1_list)
        if text1_list[len1]==',' or text1_list[len1]==u'\u0964' or text1_list[len1]=='?' or text1_list[len1]=='-' or text1_list[len1]=='!' or text1_list[len1]==':' or text1_list[len1]==';':
    ...
    for text in open(filepath):
        ...
        for k in range(0,len(token)):
            if flag_2==0:
                if token[k] in adjective.dict_adjective.keys():
                    ...
                    l.append(token[k])
                    l.append('/')
                    l.append(date_month_noun.dict_date_month_noun[token[k]])
                elif token[k] in hindi_name.dict_hindi_name_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(hindi_name.dict_hindi_name_1[token[k]])
                elif token[k] in uncountable_noun_1.dict_uncountable_noun_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(uncountable_noun_1.dict_uncountable_noun_1[token[k]])
                elif token[k] in landmark_noun_1.dict_landmark_noun_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(landmark_noun_1.dict_landmark_noun_1[token[k]])
                elif token[k] in person_name_1.dict_person_name_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(person_name_1.dict_person_name_1[token[k]])
                elif token[k] in surname_1.dict_surname_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(surname_1.dict_surname_1[token[k]])
                elif token[k] in state_noun_1.dict_state_noun_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(state_noun_1.dict_state_noun_1[token[k]])
                elif token[k] in district_noun_1.dict_district_noun_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(district_noun_1.dict_district_noun_1[token[k]])
                elif token[k] in place_noun_1.dict_place_noun_1.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(place_noun_1.dict_place_noun_1[token[k]])
                ...
                if token[k] in adjective.dict_adjective.keys():
                    ...
                    l.append('/')
                    l.append(date_month_noun.dict_date_month_noun[token[k]])
                elif token[k] in uncountable_noun.dict_uncountable_noun.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(uncountable_noun.dict_uncountable_noun[token[k]])
                elif token[k] in landmark_noun.dict_landmark_noun.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(landmark_noun.dict_landmark_noun[token[k]])
                elif token[k] in surname.dict_surname.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(surname.dict_surname[token[k]])
                elif token[k] in state_noun.dict_state_noun.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(state_noun.dict_state_noun[token[k]])
                elif token[k] in district_noun.dict_district_noun.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(district_noun.dict_district_noun[token[k]])
                elif token[k] in place_noun.dict_place_noun.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(place_noun.dict_place_noun[token[k]])
                elif token[k] in person_name.dict_person_name.keys():
                    l.append(token[k])
                    l.append('/')
                    l.append(person_name.dict_person_name[token[k]])
                else:
                    l.append(token[k])
                    l.append('/')
                    l.append('UNK')
        ...
        for k1 in range (0,len(token)-2):
            ...
            if(res_individual_testing_1=='ीय'or res_individual_prefix_1=='सु' or res_individual_prefix_1=='कम' or res_individual_prefix_three=='अत्' or res_individual_prefix_one=='अ' or res_individual_prefix_1=='अध' or res_individual_prefix_1=='भर'  or res_individual_prefix_1=='अन' or res_individual_prefix_one=='ब' or res_individual_prefix_1=='कम' or res_individual_testing_three=='ालय' or res_individual_testing_three=='शील' or res_individual_testing_four=='शाली' or res_individual_testing_five=='प्रिय'  or res_individual_testing_five=='पूर्ण' or res_individual_testing_1=='मय' or res_individual_testing_three=='मान' or res_individual_testing_three=='जनक' or res_individual_testing_three=='बान' or res_individual_testing_1=='िक' or  res_individual_testing_three=='लित' or  res_individual_testing_three=='चित' or res_individual_testing_three=='कृत'  or res_individual_testing_three=='दार' or res_individual_testing_three=='दाई' or res_individual_testing_four=='दायी' or res_individual_testing_five=='दायिक' or res_individual_testing_three=='देह' or res_individual_testing_three=='ीला'  or res_individual_testing_1=='ीण' or res_individual_testing_1=='ीन' or res_individual_testing_three=='नाक' or res_individual_testing_1=='ाऊ' or res_individual_testing_three=='वान' or res_individual_testing_1=='वर' or res_individual_testing_1=='कड़' or res_individual_testing_1=='तम' or res_individual_testing_three=='हीन' or res_individual_testing_1=='तः' or res_individual_testing_four=='त्मक' or res_individual_testing_1=='गत' or res_individual_testing_five=='कालीन' or res_individual_testing_five=='कालिक' or res_individual_testing_four=='कारी'):
                if l[3*k1+2]=='UNK' and l[3*k1+2]=='N':
                    l[3*k1+2]='JJ'
    ...
    #Tagging the verb ending with 'ता'
        ...
        if r=='ता' or r_one=='ए' or r_one==u'\u0947' or r=='एं'  or r=='ईं'  or r=='ओ' or r_one== 'ी' or  r=='ती' or r=='ते' or r=='ना' or r=='यें' or r=='गे' or r_one=='ए'  or r_one==' ी':
            if 0 <= x2 < x1 : ## Preventing from error i.e list out of index
                if l[element_length*3+2]!='QW'and l[element_length*3+2]!='Pronoun' and l[element_length*3+2]!='NEG' and l[element_length*3+2]!='Demonstrative_Pro' and l[element_length*3+2]!='NEG' and l[element_length_2*3+2]!='JJ' and l[element_length_2*3+2]!='ordinal_number' and l[element_length*3+2]!='Adverb' and l[element_length*3+2]!='Preposition'and l[element_length*3+2]!='N':
                    l[element_length*3+2]='VB'
        ...
        if r3=='ीं' or r3_one==' ी' or r3=='ही' or r3=='पे' or r3=='खा' or r3_three=='तें' or r3=='हा' or r3_three=='यें' or r3_three=='लें':
            if 0 <= x3 < x1:
                if l[element_length_3*3+2]!='QW' and l[element_length_3*3+2]!='Preposition' and l[element_length_3*3+2]!='NEG' and l[element_length_3*3+2]!='Place_N'and l[element_length_3*3+2]!='JJ' and l[element_length_3*3+2]!='ordinal_number' and l[element_length_3*3+2]!='Adverb' and l[element_length_3*3+2]!='Preposition' and l[element_length_3*3+2]!='N':
                    l[element_length_3*3+2]='VB'
        n4=len(l_char_4)-1
        if n4>=1:
        ...
        if r4=='ते' or r4=='ना' or r4_one=='ी' or r4=='गा' or r4_one=='ो':
            if 0 <= x4 <x1:
                if l[element_length_4 * 3 + 2] != 'QW' and l[element_length_4*3+2]!='NEG' and l[element_length_4*3+2]!='Place_N' and l[element_length_4*3+2]!='JJ' and l[element_length_2*3+2]!='ordinal_number' and l[element_length_4 * 3 + 2] != 'Adverb' and l[element_length_4 * 3 + 2] != 'Preposition' and l[element_length_4*3+2]!='N':
                    l[element_length_4*3+2]='VB'

    # Verb tagging rule before the conjunct
        for k3 in range(0,len(l)):
            if (l[k3]=='Conjunct' or l[k3]=='Conjunctive_VB' or l[k3]=='PU' or l[k3]=='VB') and k3!=len(l)-1 and l[k3]!='Place_N' and l[k3-3]!='Conjunct':
                r5=l[k3-5]
                r6=l[k3-8]
                if k3>=11:
                    r7=l[k3-11]
                ...
                if r6_cj=='ीं' or r6_cj=='या' or r6_cj=='के' or r6_cj_one==' ी' or r6_cj=='ही' or r6_cj=='पे' or r6_cj=='खा' or r6_cj_three=='तें' or r6_cj=='हा' or r6_cj_three=='यें' or r6_cj_three=='लें' or r6_cj == 'ता' or r6_cj == 'या' or r6_cj == 'ईं' or r6_cj == 'ओ' or r6_cj_one == 'ी' or r6_cj == 'ती' or r6_cj == 'ते' or r6_cj == 'ना' or r6_cj == 'यें' or r6_cj == 'गे' or r6_cj_one == 'ए' or r6_cj_one == ' ी':
                    if k3>=6:
                        if l[k3-6] != 'QW' and l[k3-6]!='Comjunct' and l[k3-6]!='Adverb' and l[k3-6]!='NEG' and l[k3-6]!='Preposition' and l[k3-6]!='N' and l[k3-6]!='Place_N'and l[k3-6]!='JJ':
                            l[k3-6] = 'VB'
                split5(r7)
                ...
                if r7_cj == 'ीं' or r7_cj == 'या' or r7_cj_one == ' ी' or r7_cj == 'ही' or r7_cj == 'पे' or r7_cj == 'खा' or r7_cj_three == 'तें' or r7_cj == 'हा' or r7_cj_three == 'यें' or r7_cj_three == 'लें' or r7_cj == 'ता' or r7_cj == 'या' or r7_cj == 'ईं' or r7_cj == 'ओ' or r7_cj_one == 'ी' or r7_cj == 'ती' or r7_cj == 'ते' or r7_cj == 'ना' or r7_cj == 'यें' or r7_cj == 'गे' or r7_cj_one == 'ए' or r7_cj_one == ' ी':
                    if k3>=9:
                        if l[k3 - 9] != 'QW' and l[k3-9]!='NEG' and l[k3-9]!='Conjunct' and l[k3-9]!='Adverb' and l[k3-9]!='Preposition' and l[k3-9]!='N' and l[k3-9]!='Place_N' and l[k3-9]!='JJ':
                            l[k3 - 9] = 'VB'
...
#  for printing in output file
        ...
        for g in range(0,len(l)):
            if flag_2==0:
                ...
                with open('/home/pawan/Desktop/output1.txt', 'a') as filehandle:
                    a=l[g]
                    filehandle.write(a)
                    count1=count1+1
                    c=c+1
